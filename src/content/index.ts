...
export const chapters: ChapterMeta[] = [
  {
    ...
    difficulty: 'beginner',
    estimatedTime: '2시간',
    learnings: ['AI 에이전트 핵심 개념 이해', 'Python 환경 구축', 'RAG 아키텍처 기초'],
  ...
  },
  {
    ...
    difficulty: 'beginner',
    estimatedTime: '3시간',
    learnings: ['프롬프트 엔지니어링 기법', 'LLM API 호출 실습', '멀티 모델 비교 분석'],
  ...
  },
  {
    ...
    difficulty: 'beginner',
    estimatedTime: '2.5시간',
    learnings: ['이미지 생성 AI 활용법', '비주얼 프롬프트 설계', '멀티모달 AI 이해'],
    tools: ['Gemini', 'NanoBanana Pro'],
  },
  {
    id: 4,
    slug: 'chapter-4',
    ...
    estimatedTime: '4시간',
    learnings: ['n8n 워크플로우 설계', 'Docker 기초 운용', 'Google Calendar 자동화'],
    tools: ['n8n', 'Docker', 'Google Calendar API'],
  },
  {
    id: 5,
    slug: 'chapter-5',
    ...
    difficulty: 'intermediate',
    estimatedTime: '5시간',
    learnings: ['벡터 데이터베이스 구축', '임베딩 모델 활용', 'RAG 파이프라인 설계'],
    tools: ['n8n', 'Supabase', 'Cohere'],
  },
  {
    id: 6,
    slug: 'chapter-6',
    ...
    difficulty: 'advanced',
    estimatedTime: '5시간',
    learnings: ['CRM 자동화 시스템 구축', 'MCP/A2A 프로토콜 이해', 'SMS 자동화 연동'],
    tools: ['n8n', 'Solapi', 'MCP', 'A2A'],
  },
  {
    id: 7,
    slug: 'chapter-7',
    ...
    difficulty: 'advanced',
    estimatedTime: '6시간',
    learnings: ['MCP 서버 직접 구축', '금융 데이터 API 연동', 'Telegram 봇 자동화'],
    tools: ['MCP', 'Telegram Bot', 'Alpha Vantage'],
  },
  {
    id: 8,
    slug: 'chapter-8',
    ...
    difficulty: 'advanced',
    estimatedTime: '6시간',
    learnings: ['GIS 데이터 처리', 'PostGIS 공간 쿼리', '공공데이터 API 활용'],
    tools: ['Supabase', 'PostGIS', '공공데이터 API'],
  },
]
